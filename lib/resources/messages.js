...
module.exports = function(request) {
    return {
         ...
         * @param  {Number}   delay          Delay msg send in seconds
         * @param  {Function} callback       Callback function
         */
        sendTextFromUser: function(conversationId, senderId, text, delay, callback) {
            send(conversationId, utils.messageText(senderId, text, delay), callback);
        },
